...
set_property PACKAGE_PIN T8 [get_ports {OVW_LED}]
set_property IOSTANDARD LVCMOS33 [get_ports {OVW_LED}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {NEG_LED}]
set_property IOSTANDARD LVCMOS33 [get_ports {NEG_LED}]
